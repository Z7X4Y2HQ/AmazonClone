    ...
    <View style={{ flex: 1 }}>
      ...
      >
        <Pressable
          ...
          style={{ flex: 1, alignItems: "center", backgroundColor: "rgba(0, 0, 0, 0.5)" }}
        >
          <View style={{ flex: 2 }}></View>
          <View
            style={{ flex: 1.39, width: width / 2.5, backgroundColor: "#f1f1f1", borderRadius: 10 }}
          >
      ...
      <View style={{ flex: 14, flexDirection: "row", alignItems: "flex-start" }}>
        <View style={{ flex: 1 }}>
          ...
          <ScrollView style={{ flex: 1 }}>
            ...
            >
              <Pressable>
                <Text style={{ color: "#046f84", fontSize: 12 }}>{items.title}</Text>
              </Pressable>
              <View style={{ flexDirection: "row" }}>
                ...
                <FontAwesome size={12} name="star" color={"#ffa41d"} />
                <FontAwesome size={12} name="star" color={"#ffa41d"} />
                <FontAwesome size={12} name="star-half-empty" color={"#ffa41d"}>
                  <Text style={{ fontSize: 11, color: "#046f84" }}> {items.reviews}</Text>
                </FontAwesome>
              </View>
            </View>
            <View>
              ...
              >
                ...
                >
                  <View style={{ flex: 10, flexDirection: "row" }}>
                    <Text>
                      Operating System:{" "}
                      {isExpanded && <Text style={{ fontWeight: "bold" }}> Win 11</Text>}{" "}
                      {!isExpanded && (
                  ...
                  <View style={{ paddingLeft: 14, backgroundColor: "white" }}>
                    <Pressable
                      ...
                      style={{
                        ...
                        borderRadius: 3,
                        borderWidth: 1,
                        borderColor: selectedCardIndex == 0 ? "#b98046" : "#bdbfc3",
                        height: 125,
                        width: 140,
                      }}
                    >
                      <Text
                        style={{
                          padding: 10,
                          backgroundColor: selectedCardIndex == 0 ? "#fcf8f7" : "#f9f9f9",
                          borderBottomWidth: 0.5,
                          borderBottomColor: "#bdbfc3",
                          color: "black",
                        }}
                      >
                        Win 11
                  ...
                  <View style={{ paddingLeft: 14, backgroundColor: "white" }}>
                    <Pressable
                      ...
                      style={{
                        ...
                        borderRadius: 3,
                        borderWidth: 1,
                        borderColor: selectedCardIndex == 1 ? "#b98046" : "#bdbfc3",
                        height: 125,
                        width: 140,
                      }}
                    >
                      <Text
                        style={{
                          padding: 10,
                          backgroundColor: selectedCardIndex == 1 ? "#fcf8f7" : "#f9f9f9",
                          borderBottomWidth: 0.5,
                          borderBottomColor: "#bdbfc3",
                          color: "black",
                        }}
            ...
            <View style={styles.detail}>
              ...
              >
                ...
                >
                  ...
                  <Text> </Text>
                  <Foundation name="info" size={20} color="#969696" />
                  <Text
                    style={{ lineHeight: 18, fontSize: 12, color: "#969696", fontStyle: "italic" }}
                  >
                    {" "}
                    Save $277.10 (15%)
                  </Text>
              ...
              <Text style={{ paddingHorizontal: 14, color: "black" }}>
                Delivery <Text style={{ fontWeight: "bold" }}>May 4 - 17</Text>
              </Text>
              ...
              <Text style={{ paddingHorizontal: 14, fontSize: 16, color: "#0b6d0c" }}>
                In Stock.
              </Text>
              <View
                style={{
              ...
              >
                ...
                >
                  <Text style={{ fontSize: 12, paddingHorizontal: 8, paddingVertical: 8 }}>
                    Qty: {qty} <AntDesign name="down" size={14} color="black" />
                  </Text>
                </Pressable>
              </View>
              <View style={{ paddingHorizontal: 14 }}>
                <TouchableOpacity
                  ...
                  style={[styles.cart, { backgroundColor: emptyCart ? "#fed813" : "white" }]}
                >
            ...
            <View style={{ paddingHorizontal: 14, backgroundColor: "white" }}>
              <Text style={{ paddingBottom: 10, fontWeight: "bold", fontSize: 15 }}>
                Add an Accessory:
              </Text>
            </View>
            <View
              style={{ flex: 1, flexDirection: "row", paddingLeft: 14, backgroundColor: "white" }}
            >
              <View
                style={{
                  justifyContent: "center",
                ...
                <View style={{ flex: 1, flexDirection: "row" }}>
                  <View style={{ flex: 7, justifyContent: "center", alignItems: "flex-start" }}>
                    <Text style={{ fontSize: 15 }}>
                      Microsoft 365 Family | Premium Office Apps | Up to 6 Users | 3 Months Free,
                      p...
                    </Text>
            ...
            >
              ...
              >
                <View style={{ flex: 1, flexDirection: "row" }}>
                  <View style={{ flex: 7, justifyContent: "center", alignItems: "flex-start" }}>
                    <Text style={{ fontSize: 15 }}>
                      Microsoft 365 Personal | Premium Office Apps | 1 User, Up to 5 Devices | 3
                      Mon...
                    </Text>
            ...
            >
              ...
              <Text style={{ fontSize: 15 }}>
                ...
                <Text style={{ color: "#15798b" }}>other sellers </Text>that may not offer free
                Prime Shipping.
              </Text>
            </View>
            <View
            ...
            >
              ...
              <View style={{ flex: 1, flexDirection: "row" }}>
                <View style={{ flex: 1, margin: 5, justifyContent: "space-between" }}>
                  ...
                  <Text style={{ color: "#575958", marginVertical: 6 }}>
                    Ram Memory Installed Size
                  </Text>
                  {!detailsSeeMore && (
                    <Pressable
                      onPress={() => {
                        setDetailsSeeMore(!detailsSeeMore);
                      }}
                      style={{
                        flex: 1,
                        flexDirection: "row",
            ...
            >
              <Text style={{ paddingVertical: 7, fontSize: 15 }}>
                <Text style={{ fontWeight: "bold" }}>Note: </Text>Products with electrical plugs are
                designed for use in the US. Outlets and voltage differ internationally and this
                product may require an adapter or converter for use in your destination. Please
            ...
            >
              <Image
                ...
                source={{ uri: "https://m.media-amazon.com/images/I/71iOM0MH+qL._AC_SX679_.jpg" }}
              />
              <View style={{ flex: 1, paddingTop: 10 }}>
                <Text style={{ paddingLeft: 20 }} numberOfLines={3}>
                  2022 Latest Dell Inspiron 5000 5510 15.6" FHD (Intel 4-Core i7-11390H, 16GB RAM,
                  1TB PCIe SSD), 1080p Full HD Business Laptop, Webcam, Thunderbolt 4, Fingerprint
                  Reader, Backlit KB, Windows 11 Pro
                </Text>
                <View
                  style={{
                    flex: 1,
                ...
                >
                  ...
                  <Text
                    style={{ lineHeight: 12, color: "#2491be", fontSize: 12, fontWeight: "bold" }}
                  >
                    prime
                  </Text>
                </View>
            ...
            >
              ...
              <Text style={{ paddingVertical: 7, fontSize: 15 }}>
                Deliver necessary portability with uncompromising features on the LG gram 17Z95P. It
                has a huge 17-Inch WQXGA (2560x1600) IPS display while still slim and light enough
                to take anywhere. At under three pounds and delivering near all day battery life
                this LG gram is great to carry around for a long day of work. The 17Z95P also
                impresses with an Intel 11th Generation i7- 1195G7 CPU on the certified Intel Evo
                Platform with Iris Xe Graphics 16GB RAM a 1TB NVMe SSD and Thunderbolt 4
                connectivity. With Windows 11 Home operating system. MobileMark 2014 standard
                (MobileMark is a trademark of the Business Applications Performance Corporation)
                Performance level is utilized for comparison purposes only and does not necessarily
                reflect the battery life that will be achieved Actual battery life will vary from
                specifications depending on model setup configuration applications used features
            ...
            >
              ...
              <View style={{ backgroundColor: "white", flex: 1 }}>
                ...
                >
                  ...
                  <Text style={{ marginRight: 15, marginBottom: 4, fontSize: 15 }}>
                ...
                >
                  ...
                  <Text style={{ marginRight: 15, marginBottom: 4, fontSize: 15 }}>
                    Intel Evo Platform Powered by 11th generation Intel core i7-1195G7 Processor
                    with Intel Xe Graphics delivers performance for high-resolution content creation
                    and editing
                  </Text>
                </View>
                <View
                ...
                >
                  ...
                  <Text style={{ marginRight: 15, marginBottom: 4, fontSize: 15 }}>
                    16GB LPDDR4X 4266mhz RAM delivers a high level of performance for
                    memory-intensive content creation, designing, editing, and multitasking
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  ...
                  <Text style={{ marginRight: 15, marginBottom: 4, fontSize: 15 }}>
                    Improve productivity with 1TB PCIe M.2 NVMe SSD for dependable storage
                ...
                >
                  ...
                  <Text style={{ marginRight: 15, marginBottom: 4, fontSize: 15 }}>
                    Connect with Confidence: Two USB-C ports with Thunderbolt 4 support, two USB-A
                    3.2 ports, a full-size HDMI port, a microSD card reader, and a 3.5mm audio jack
                  </Text>
                </View>
              </View>
            </View>
