          ...
          <ScrollView>
            ...
            >
              <View style={{ height: 60, marginBottom: 25 }}>
                <Text style={styles.signInHeading}>Sign In For the Best Experience</Text>
              </View>
            </LinearGradient>
            <View style={{ alignItems: "center" }}>
              <Pressable
                onPress={() => navigation.navigate("LoginScreen")}
                style={[styles.button, { marginBottom: 15, backgroundColor: "#f1c876" }]}
              >
                <Text>Sign In</Text>
              </Pressable>
              <Pressable
                onPress={() => navigation.navigate("LoginScreen")}
                style={[styles.button, { backgroundColor: "#eff0f4" }]}
              >
            ...
            <View style={styles.signInPerks}>
              ...
              <View>
                <Text style={[styles.perksText, { marginVertical: 30, width: 260 }]}>
